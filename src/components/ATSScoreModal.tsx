                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-xs font-bold text-slate-600 dark:text-slate-400">
                        {atsData.breakdown.primaryKeywords?.matched}/{atsData.breakdown.primaryKeywords?.total}
                      </span>
                    </div>
                    <div className="w-full bg-slate-200 dark:bg-slate-700 rounded-full h-2">
                      <div
                        className={`h-2 rounded-full ${getProgressColor(atsData.breakdown.primaryKeywords?.percentage || 0)}`}
                        style={{ width: `${atsData.breakdown.primaryKeywords?.percentage || 0}%` }}
                      />
                    </div>
                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                      {Math.round(atsData.breakdown.primaryKeywords?.percentage || 0)}% matched
                    </p>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-xs font-bold text-slate-600 dark:text-slate-400">
                        {atsData.breakdown.secondaryKeywords?.matched}/{atsData.breakdown.secondaryKeywords?.total}
                      </span>
                    </div>
                    <div className="w-full bg-slate-200 dark:bg-slate-700 rounded-full h-2">
                      <div
                        className={`h-2 rounded-full ${getProgressColor(atsData.breakdown.secondaryKeywords?.percentage || 0)}`}
                        style={{ width: `${atsData.breakdown.secondaryKeywords?.percentage || 0}%` }}
                      />
                    </div>
                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                      {Math.round(atsData.breakdown.secondaryKeywords?.percentage || 0)}% matched
                    </p>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-xs font-bold text-slate-600 dark:text-slate-400">
                        {atsData.breakdown.matchingSkills?.matched}/{atsData.breakdown.matchingSkills?.total}
                      </span>
                    </div>
                    <div className="w-full bg-slate-200 dark:bg-slate-700 rounded-full h-2">
                      <div
                        className={`h-2 rounded-full ${getProgressColor(atsData.breakdown.matchingSkills?.percentage || 0)}`}
                        style={{ width: `${atsData.breakdown.matchingSkills?.percentage || 0}%` }}
                      />
                    </div>
                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                      {Math.round(atsData.breakdown.matchingSkills?.percentage || 0)}% matched
                    </p>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-xs font-bold text-slate-600 dark:text-slate-400">
                        {Math.round(atsData.breakdown.formatQuality?.score || 0)}/100
                      </span>
                    </div>
                    <div className="w-full bg-slate-200 dark:bg-slate-700 rounded-full h-2">
                      <div
                        className={`h-2 rounded-full ${getProgressColor(atsData.breakdown.formatQuality?.score || 0)}`}
                        style={{ width: `${atsData.breakdown.formatQuality?.score || 0}%` }}
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-xs font-bold text-slate-600 dark:text-slate-400">
                        {Math.round(atsData.breakdown.seniorityAlignment?.score || 0)}/100
                      </span>
                    </div>
                    <div className="w-full bg-slate-200 dark:bg-slate-700 rounded-full h-2">
                      <div
                        className={`h-2 rounded-full ${getProgressColor(atsData.breakdown.seniorityAlignment?.score || 0)}`}
                        style={{ width: `${atsData.breakdown.seniorityAlignment?.score || 0}%` }}
                      />
                    </div>
                  </div>
                </div>
